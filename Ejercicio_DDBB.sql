...
SELECT ID_Perro, Nombre_Perro, Fecha FROM Perro JOIN Historial
ON Historial.Perro = Perro.ID_Perro
WHERE Fecha BETWEEN "2022-01-01" AND "2022-12-30"
ORDER BY ID_Perro;

--- 5)Realice una consulta multitabla que arroje el nombre de todos los perros cuyos dueños se llaman Pedro
SELECT ID_Perro, Perro.Nombre_Perro, Dueno.Nombre FROM Perro JOIN Dueno
