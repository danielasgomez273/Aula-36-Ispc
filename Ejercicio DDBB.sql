...
SELECT ID_Perro, Perro.Nombre_Perro, Dueno.Nombre, Historial.Fecha FROM Perro JOIN Dueno JOIN Historial
ON Perro.DNI_Dueno = Dueno.DNI AND Historial.Perro = Perro.ID_Perro
WHERE Perro.Fecha_nac < "2017-08-14"
AND Fecha < "2021-12-30"
ORDER BY ID_Perro;
